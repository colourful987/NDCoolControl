#
#  Be sure to run `pod spec lint NDCoolControl.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "colourful987" => "mcxcode@163.com" }
  # Or just: spec.author    = "colourful987"
  # spec.authors            = { "colourful987" => "mcxcode@163.com" }
  # spec.social_media_url   = "https://twitter.com/colourful987"
